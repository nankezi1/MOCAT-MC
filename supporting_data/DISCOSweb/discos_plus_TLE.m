%% Merge TLE and DISCOS data
% ...and SATCAT (for active/inactive)
% create mat_sats for initialized.mat

% % earth gravitational parameter
% mu = 3.986004418e5; % km s kg
...
%       Above query: history of TLE's (GP) for epoch between 1/1/23 - 1/3/23, active sats, mean motion > 3 revs/days
...
tlename = 'spacetrack_TLE_07_01-03_2018.csv';  
tlename = 'spacetrack_TLE_01_01-03_2023_LEO'
